@QACATERALL-2222 @UJBalances3 @UJBalances @AISUJ
Feature: UJ balances Select account from Multiple Account list
  ...
  @QACATERALL-2357 @id:QACATERALL-2222_1 @Prateek @4ABalUJ3
  Scenario: Token_1.13 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2358 @id:QACATERALL-2222_2 @Prateek @4ABalUJ3
  Scenario: account-access-consents_1.UJ3-Balances : Verify account access consent service for All permissions
  ...
  @QACATERALL-2359 @id:QACATERALL-2222_3 @Prateek @4ABalUJ3
  Scenario: Token_2.UJ3-Balances : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2360 @id:QACATERALL-2222_4 @Prateek @4ABalUJ3
  Scenario: Token_3.UJ3-Balances : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2361 @id:QACATERALL-2222_5 @Prateek @4ABalUJ3
  Scenario: balances_1.UJ3-Balances : Verify balances service for valid Account against

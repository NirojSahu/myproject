@QACATERALL-2232 @UJDirectdebits3 @UJDirectdebits @AISUJ
Feature: UJ Directdebit Multiple Account Select Single Account
  ...
  @QACATERALL-2420 @id:QACATERALL-2232_1 @Prateek @4ADirDebUJ3
  Scenario: Token_1.35 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2421 @id:QACATERALL-2232_2 @Prateek @4ADirDebUJ3
  Scenario: account-access-consents_1.UJ3-Directdebits : Verify account access consent service for All permissions
  ...
  @QACATERALL-2422 @id:QACATERALL-2232_3 @Prateek @4ADirDebUJ3
  Scenario: Token_2.UJ3-Directdebits : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2423 @id:QACATERALL-2232_4 @Prateek @4ADirDebUJ3
  Scenario: Token_3.UJ3-Directdebits : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2424 @id:QACATERALL-2232_5 @Prateek @4ADirDebUJ3
  Scenario: directdebits_1.UJ3-Directdebits : Verify direct debits service for valid DD Response

@QACATERALL-2228 @UJBeneficiaries4 @UJBeneficiaries @AISUJ
Feature: UJ Beneficiaries With out ReadBeneficiariesDetail Permissions
  ...
  Environments : 3A(Dev), 5A(Pre)
   ...
   UserJourney:"With out ReadBeneficiariesDetail Permissions"
   ApplicationAcessToken --> ConsentID Gen --> AUTH URL --> ClientAccessToken  --> Hit AIS Resources

  @QACATERALL-2394 @id:QACATERALL-2228_1 @Prateek @4ABenUJ4
  Scenario: Token_1.31 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2395 @id:QACATERALL-2228_2 @Prateek @4ABenUJ4
  Scenario: account-access-consents_1.UJ4-Beneficiaries : Verify account access consent service for All permissions
  ...
  @QACATERALL-2396 @id:QACATERALL-2228_3 @Prateek @4ABenUJ4
  Scenario: Token_2.UJ4-Beneficiaries : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2397 @id:QACATERALL-2228_4 @Prateek @4ABenUJ4
  Scenario: Token_3.UJ4-Beneficiaries : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2398 @id:QACATERALL-2228_5 @Prateek @4ABenUJ4
  Scenario: beneficiaries_1.UJ4-Beneficiaries : Verify beneficiaries service for valid Response without permission
    ...
    Then I verify the cases against Banking portal for Beneficiaries with response status code "403"

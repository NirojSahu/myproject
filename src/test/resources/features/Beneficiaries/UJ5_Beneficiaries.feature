@QACATERALL-2229 @UJBeneficiaries5 @UJBeneficiaries @AISUJ
Feature: UJ Beneficiaries With single beneficiary in selected Account
  ...
  @QACATERALL-2400 @id:QACATERALL-2229_1 @Prateek @4ABenUJ5
  Scenario: Token_1.32 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2401 @id:QACATERALL-2229_2 @Prateek @4ABenUJ5
  Scenario: account-access-consents_1.UJ5-Beneficiaries : Verify account access consent service for All permissions
  ...
  @QACATERALL-2402 @id:QACATERALL-2229_3 @Prateek @4ABenUJ5
  Scenario: Token_2.UJ5-Beneficiaries : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2403 @id:QACATERALL-2229_4 @Prateek @4ABenUJ5
  Scenario: Token_3.UJ5-Beneficiaries : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2404 @id:QACATERALL-2229_5 @Prateek @4ABenUJ5
  Scenario: beneficiaries_1.UJ5-Beneficiaries : Verify beneficiaries service for valid Response without permission

@QACATERALL-2224 @UJBalances5 @UJBalances @AISUJ
Feature: UJ balances Validate multiple accounts with no consent
  ...
  @QACATERALL-2367 @id:QACATERALL-2224_1 @Prateek @4ABalUJ5
  Scenario: Token_1.15 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2368 @id:QACATERALL-2224_2 @Prateek @4ABalUJ5
  Scenario: account-access-consents_1.UJ5-Balances : Verify account access consent service for All permissions
  ...
  @QACATERALL-2369 @id:QACATERALL-2224_3 @Prateek @4ABalUJ5
  Scenario: Token_2.UJ5-Balances : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2370 @id:QACATERALL-2224_4 @Prateek @4ABalUJ5
  Scenario: Token_3.UJ5-Balances : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2371 @id:QACATERALL-2224_5 @Prateek @4ABalUJ5
  Scenario: balances_1.UJ5-Balances1 : Verify balances service for valid Account against
   ...
   # Then I want to validate service Response and store the BalanceInfo with Status code "403"
   Then I verify the cases against Banking portal for Balances with response status code "200"

  @QACATERALL-2372 @id:QACATERALL-2224_6 @Prateek @4ABalUJ5
  Scenario: balances_1.UJ5-Balances2 : Verify balances service for valid Account against
    Given I have the data available to create "GET" request for balances_service with Headers
    When I want to make a call to balances_service to get balance information
    Then I want to validate service Response and store the BalanceInfo with Status code "400"
   #Then I verify the cases against Banking portal for Balances with response status code "200"

  @QACATERALL-2373 @id:QACATERALL-2224_7 @Prateek @4ABalUJ5
  Scenario: balances_1.UJ5-Balances3 : Verify balances service for valid Account against
   Given I have the data available to create "GET" request for balances_service with Headers
   When I want to make a call to balances_service to get balance information
   #Then I want to validate service Response and store the BalanceInfo with Status code "403"
   Then I verify the cases against Banking portal for Balances with response status code "200"

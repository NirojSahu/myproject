@QACATERALL-2223 @UJBalances4 @UJBalances @AISUJ
Feature: UJ balances Select account with out "ReadBalance" permission
  ...
  Environments : 3A(Dev), 5A(Pre)
   ...
   UserJourney:"Without ReadBalances Permissions"
   ApplicationAcessToken --> ConsentID Gen --> AUTH URL --> ClientAccessToken  --> Hit AIS Resources

  @QACATERALL-2362 @id:QACATERALL-2223_1 @Prateek @4ABalUJ4
  Scenario: Token_1.14 : Verify application access consent token is generated successfully
  ...
  @QACATERALL-2363 @id:QACATERALL-2223_2 @Prateek @4ABalUJ4
  Scenario: account-access-consents_1.UJ4-Balances : Verify account access consent service for All permissions
  ...
  @QACATERALL-2364 @id:QACATERALL-2223_3 @Prateek @4ABalUJ4
  Scenario: Token_2.UJ4-Balances : Generating Auth URL with Scope_type Account
  ...
  @QACATERALL-2365 @id:QACATERALL-2223_4 @Prateek @4ABalUJ4
  Scenario: Token_3.UJ4-Balances : Verify  customer access consent token is generated successfully for valid code
  ...
  @QACATERALL-2366 @id:QACATERALL-2223_5 @Prateek @4ABalUJ4
  Scenario: balances_1.UJ4-Balances : Verify balances service for valid Account against

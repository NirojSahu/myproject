...
public class SearchResults extends Utilities.seleniumcustomframework.extension.PageSection {
    @Utilities.seleniumcustomframework.extension.annotations.Section
    @FindBy(
        css = "div.rc"
    )
